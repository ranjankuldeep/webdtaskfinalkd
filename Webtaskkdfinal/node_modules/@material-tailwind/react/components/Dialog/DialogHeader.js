...
var DialogHeader = React.forwardRef(function(_param, ref) {
    var className = _param.className, children = _param.children, rest = function(source, excluded) {
        ...
        "className",
        "children"
    ]), dialogHeader = useTheme().dialogHeader, defaultProps = dialogHeader.defaultProps, base = dialogHeader.styles.base;
    className = null != className ? className : defaultProps.className;
    var dialogHeaderClasses = classnames(objectsToString(base), className);
